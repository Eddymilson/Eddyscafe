...
class _CadastroWidgetState extends State<CadastroWidget>
  ...
  void initState() {
    ...
    _model.emailEntrarTextController ??= TextEditingController();
    _model.emailEntrarFocusNode ??= FocusNode();

    _model.senhaEntrarTextController ??= TextEditingController();
    _model.senhaEntrarFocusNode ??= FocusNode();
                                ...
                                child: Column(
                                  children: [
                                    Align(
                                      ...
                                      child: TabBar(
                                        isScrollable: true,
                                        labelColor: const Color(0xFFB0A455),
                                        ...
                                        indicatorColor: const Color(0xFFB38521),
                                        indicatorWeight: 4.0,
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 12.0, 16.0, 12.0),
                                        tabs: const [
                                                ...
                                                children: [
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        cursorColor:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .primary,
                                                        validator: _model
                                                            .emailEntrarTextControllerValidator
                                                            .asValidator(
                                                                context),
                                                      ),
                                                    ),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            .senhaEntrarTextController,
                                                        focusNode: _model
                                                            .senhaEntrarFocusNode,
                                                        autofocus: false,
                                                        autofillHints: const [
                                                          AutofillHints.email
                                                        ],
                                                        obscureText: !_model
                                                            .senhaEntrarVisibility,
                                                        decoration:
                                                            InputDecoration(
                                                          labelText: 'Senha',
                                                          labelStyle:
                                                        ...
                                                        cursorColor:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .primary,
                                                        validator: _model
                                                            .senhaEntrarTextControllerValidator
                                                            .asValidator(
                                                                context),
                                                      ),
                                                    ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: Image.network(
                              'https://images.unsplash.com/photo-1495862433577-132cf20d7902?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxNHx8Y29mZmVlfGVufDB8fHx8MTczMDM1NjQzNHww&ixlib=rb-4.0.3&q=80&w=1080',
                            ).image,
                          ),
                          borderRadius: const BorderRadius.only(
